...
export default class ParallaxScroll extends Component {
  static propTypes = {
    ...
    scrollableComponent: PropTypes.oneOfType([
      PropTypes.func,
      PropTypes.object,
    ]),
  ...
  constructor(props) {
    ...
    this.scrollableComponent = props.scrollableComponent || ScrollView;
    ...
    return [
      {
        data: [{key: KEY}],
        key: KEY,
        renderItem: this._renderBackgroundPlaceholder,
      },
      ...sections,
    ];
  }
      ...
      style.transform = [
        {
          translateY: this.scrollY.interpolate({
            inputRange: parallaxHeightWithoutHeader
              ...
              : [0, parallaxHeight],
            outputRange: parallaxHeightWithoutHeader
              ? [0, 0, -height]
              : [0, -height],
            extrapolate: 'clamp',
          }),
  ...
  render() {
    ...
    return (
      <View style={[wrapperStyle, {width, height}]} onLayout={this._onLayout}>
        {renderParallaxBackground &&
          this._renderParallaxBackground(!!renderHeader)}
        ...
        <ScrollableComponent
          ...
          dataSource={
            dataSource && renderRow && this._getDataSource(dataSource)
          }
